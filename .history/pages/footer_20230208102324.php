    ...
    <div class="row">
      <div class="col-lg-3">
        <div class="link-box">
          ...
          <div class="link-box__link"><a style="text-decoration:none; color:white" href="index.php?quanly=t=dangnhap">Đăng nhập</a></div></div>
          <div class="link-box__link">Đăng ký</div>
        </div>
      </div>
      </div>
          <div class="input-box">
