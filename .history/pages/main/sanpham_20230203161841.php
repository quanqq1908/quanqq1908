...
while ($row_chitiet = mysqli_fetch_array($query_chitiet)) {
    ...
    <div class="wrapper_chitiet">
        ...
        <form method="POST" action="pages/main/sthemgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham']?>">
        <div class="chitiet_sanpham">
           <p><?php echo $row_chitiet['tensanpham']?></p> 
            ...
            <p><input class="btn_giohang" name="themgiohang" type="submit" value="Thêm vào giỏ"></p>
        </div>
        </form>
</div>
<?php
