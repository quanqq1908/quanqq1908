...
<table style="width: 100%; text-align:center; border-collapse:collapse" border="1" >
  ...
  <tr>
    ...
    <td >
      <a style="color:red; text-decoration: none; "href="pages/main/themgiohang.php?cong=<?php echo $cart_item['id']?>">+</a>
    <?php echo $cart_item['soluong']?>
      <a style="color:red;text-decoration: none;" href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id']?>">-</a>
  </td>
...
?>
 <tr>
    ...
    <p style="float:right"><a style="color:#ddd;text-decoration: none" href="pages/main/themgiohang.php?xoatatca=1">Xóa tất cả</a></p>
  </td>
    </tr>
<?php 
  } else {
