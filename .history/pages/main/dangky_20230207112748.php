<?php
  ...
  $sql_dangky = mysqli_query($mysqli, "INSERT INTO tbl_dangky(tenkhachhang,matkhau,email,diachi,dienthoai) VALUE('".$tenkhachhang."','".$matkhau."','".$email."','".$diachi."','".$dienthoai."',) ");
  if($sql_dangky){
...
<form action="" method="POST">
  <div class="container">
    ...
    <input type="text" placeholder="Điền họ và tên" name="tenkhachhang" required>
