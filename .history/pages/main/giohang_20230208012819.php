...
?>
 <tr>
    ...
    if (isset($_SESSION['dangky'])) {
      ?>
      <button type="button" ><a style="color:white;text-decoration: none;" href="index.php?quanly=thanhtoan">Đặt hàng</a></button>
    <?php
    } else {
      ?>
       <button type="button"><a style="text-decoration: none;" href="index.php?quanly=dangky">Đăng ký đặt hàng</a>
        <p> </p>
    <?php
    }
    ?>
