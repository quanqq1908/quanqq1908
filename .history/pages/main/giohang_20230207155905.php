...
?>
 <tr>
    ...
    if (isset($_SESSION['dangky'])) {
      ?>
       <p><a style="color:orange;text-decoration: none;" href="index.php?quanly=thanhtoan">Đặt hàng</a> </p>
    <?php
    } else {
      ?>
        <p><a style="color:orange;text-decoration: none;" href="index.php?quanly=dangky">Đăng ký đặt hàng</a> </p>
    <?php
    }
    ?>
