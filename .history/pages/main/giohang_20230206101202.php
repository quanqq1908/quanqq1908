...
<table style="width: 100%; text-align:center; border-collapse:collapse" border="1" >
  ...
  <tr>
    ...
    <?php echo $cart_item['soluong']?>
      <a style="color:green;text-decoration: none;" href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id']?>">-</a>
  </td>
...
?>
 <tr>
    ...
    <p style="float:right"><a style="text-decoration: none" href="pages/main/themgiohang.php?xoatatca=1">Xóa tất cả</a></p>
  </td>
    </tr>
<?php 
  } else {
