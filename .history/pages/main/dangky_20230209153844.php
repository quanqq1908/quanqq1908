...
<form action="" autocomplete="off" method="POST">
  <div class="container">
    ...
    <input class="r" type="text" placeholder="Điền họ và tên" id="hovaten" name="hovaten" required>
    ...
    <input  class="r" type="password" placeholder="Điền mật khẩu" id="matkhau" name="matkhau" required>
