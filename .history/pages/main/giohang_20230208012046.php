...
?>
 <tr>
    ...
    if (isset($_SESSION['dangky'])) {
      ?>
      <button type="button" class="btn"><a style="color:red;text-decoration: none;" href="index.php?quanly=thanhtoan">Đặt hàng</a></button>
    <?php
    } else {
      ?>
       <button type="button" class="btn"><a style="color:red;text-decoration: none;" href="index.php?quanly=dangky">Đăng ký đặt hàng</a>
        <p> </p>
    <?php
    }
    ?>
