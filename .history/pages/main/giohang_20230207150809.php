...
?>
 <tr>
    ...
    if (isset($_SESSION['dangky'])) {
      ?>
       <p><a style=" font-size:25px;color:red;text-decoration: none;" href="">Đặt hàng</a> </p>
    <?php
    } else {
      ?>
        <p><a style=" font-size:25px;color:red;text-decoration: none;" href="">Đăng ký Đặt hàng</a> </p>
    <?php
    }
    ?>
