...
if(isset($_POST['themsanpham'])){
    ...
    header('Location:../../indexxx.php?action=quanlysanpham&query=them');
} elseif(isset($_POST['suasanpham']))  {
    //sua
    if($_POST['hinhanh']){
    $sql_update = "UPDATE tbl_sanpham SET tensanpham='".$tenloaisp."', masp='".$masp."', giasp='".$giasp."', soluong ='".$soluong."', hinhanh='".$hinhanh."', tomtat='".$tomtat."', noidung='".$noidung."', tinhtrang='".$tinhtrang."' WHERE id_sanpham='$_GET[idsanpham]'";
    }else{
