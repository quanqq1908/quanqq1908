...
<table width= 70% style="border-collapse:collapse; margin: 10px;">
...
<tr>
  ...
  <tr>
   <td>Tóm tắt</td>
    <td><textarea rows="5" style="resize: none" name="tomtat" required></textarea></td>
  </tr>
  <tr>
   <td>Nội dung</td>
    <td><textarea cols="50" rows="7" name="noidung" required></textarea></td>
  </tr>
  <tr>
    <td>Số lượng</td>
